...
1. **Writing new code** - Before implementing, check assumptions and define success criteria
2. **Reviewing code** - Identify overcomplication, unnecessary features, or style drift
3. **Refactoring** - Ensure changes are surgical and goal-driven
4. **Debugging** - Reproduce issues first, then fix with minimal changes
5. **Planning tasks** - Break down multi-step work with verification checkpoints

### Integration with Project Rules

This skill complements project-specific rules by providing behavioral guidelines for how to approach coding tasks. Use it alongside:
...
If using Cursor, you can copy the `.cursor/rules/karpathy-guidelines.mdc` file to your project's `.cursor/rules/` directory to apply these guidelines automatically.

### For Claude Users

Place `CLAUDE.md` in your project root or merge its contents into existing project instructions.

---
*Based on Karpathy-inspired behavioral guidelines for reducing common LLM coding mistakes.*